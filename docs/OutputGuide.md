...
|                    |                          |                                                                                          | Nematic energy                 | `tMPC_nem`                                                        |
| `colourOut` or `mpDensOut`   | `multiphase.dat`         | Colour/ phi/ species-type field                                                          | Time                           | `t`                                                               |
|                    |                          |                                                                                          | X, Y, Z co-ordinates           | `QX`,`QY`,`QZ`                                                    |
|                    |                          |                                                                                          | multiphase                     | `N_0`,`N_1`, ...                                                             |
| `pressureOut`      | `pressure.dat`           | Pressure field                                                                           | Time                           | `t`                                                               |
|                    |                          |                                                                                          | X, Y, Z co-ordinates           | `QX`,`QY`,`QZ`                                                    |
|                    |                          |                                                                                          | Pressure tensor components     | `Pxx`,`Pxy`...`Pzy`,`Pzz`   
| `spPressureOut`      | `sppressure.dat`           | Specific pressure in multiphase fluids                                                                          | Time                           | `t`                                                               |
|                    |                          |                                                                                          | Average and std of pressure due to species N          | `avPN`,`stdPN`                                                   
| `avCoMOut`     | `com.dat`        | CoM of each species                                                                         | Time                           | `t`                                                               |
|                    |                          |                                                                                          | Coordinates of centre of mass of species N             | `XN`,`YN`,`ZN`                                                       |
